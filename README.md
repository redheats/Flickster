# Flickster
Build a read-only movie listing app using the Movie Database 
...
-[Link to Video Walkthrough](https://www.dropbox.com/s/6u83nfdoko27t2n/flicks.mp4?dl=0)
